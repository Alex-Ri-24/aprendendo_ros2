...
class MeuNo(Node):
    ...
    def transf_coord(self, caminho):
        ...
        for y, x in caminho:
            ...
            sim_y = (centralizado_y / 200) * -10  # -10: Invertido para ajustar a rotação
            ...
            if self.pose and self.path:
                ...
                if distance <= self.target_tolerance:
                    ...
                    if self.current_target_index >= len(self.path):
                        ...
                        break                                   # Objetivo foi alcançado

                # Caso contrário, gira para alinhar com o próximo ponto
                else:
                    target_angle = self.calculate_angle(target)
